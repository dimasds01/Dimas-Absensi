          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title">Admin</h3>
                <p class="card-feature__subtitle">Dimas Dwi Saputra  </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">0813-1275-5270</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title">HIM</h3>
                <p class="card-feature__subtitle">RICE</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer class="footer-area section-gap">
		<div class="container">
			...
			<div class="footer-bottom row align-items-center text-center text-lg-left">
				<p class="footer-text m-0 col-lg-8 col-md-12"> </script> PT.HARAPAN INSANI MANAJEMEN | RICE
