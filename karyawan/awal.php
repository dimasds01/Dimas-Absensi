            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
						...
						<br>
						<h3 style="text-align: center;">"Maksimal Absen Datang Jam 08:00"</h3>
						<h3 style="text-align: center;">Harap Absen Tepat Waktu Ya Gaes</h3>
							...
							<form action="dt_absen_sv.php" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><button type="submit" name="simpan" class="btn btn-primary">Absen Datang</button></td>
                                                <td><button type="submit" name="update" class="btn btn-warning">Absen Pulang</button></td>
                                            </tr> 
